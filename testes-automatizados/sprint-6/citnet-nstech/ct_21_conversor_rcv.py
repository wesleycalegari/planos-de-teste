"""
CT-CTN-021 — Conversor RCV (Ramo 59)
...
RAMO_VAL = "59;CIT-AVB-RCV"
TEST_FILE = Path("c:/projetos/planos-de-teste/scripts/arquivos-teste/rcv_teste.txt")


def test_ct_21_conversor_rcv(citnet_session):
    page = citnet_session
    e = ev(CT_ID)
    ...
    assert RAMO_VAL in ramos, f"Ramo RCV ({RAMO_VAL}) não encontrado no conversor NSTECH"
    ...
    shot(page, e, "02_ramo_rcv_selecionado.png")
